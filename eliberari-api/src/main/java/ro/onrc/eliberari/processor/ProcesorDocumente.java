...
public class ProcesorDocumente {
    ...
    public ProcesorDocumente(ProcesorPagina procPagina, PdfService pdfService,
            AppConfig config) {
            ...
            for (int i = 0; i < document.getNumberOfPages(); i++) {
                ...
                if (infoPag.getPagina() != TipPagina.PagGoala) {
                    ...
                    if (infoPag.getPagina() != TipPagina.Altele) {
                        ...
                        if (infoPag.getPagina() == TipPagina.CI)
                            listaCereri.getLast().setCi(true);
                        if (infoPag.getPagina() == TipPagina.CIM)
                            listaCereri.getLast().setCim(true);
                        if (infoPag.getPagina() == TipPagina.Constatator)
